...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateNoteVm', function() {
      beforeEach(function() {
        instance = new Notes.CreateNoteVm();
      });

      it('should create an instance of CreateNoteVm', function() {
        // TODO: update the code to test CreateNoteVm
        expect(instance).to.be.a(Notes.CreateNoteVm);
      });
