...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MatricesEnum', function() {
      beforeEach(function() {
        instance = Notes.MatricesEnum;
      });

      it('should create an instance of MatricesEnum', function() {
        // TODO: update the code to test MatricesEnum
