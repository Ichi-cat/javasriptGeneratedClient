...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NoteDto', function() {
      beforeEach(function() {
        instance = new Notes.NoteDto();
      });

      it('should create an instance of NoteDto', function() {
        // TODO: update the code to test NoteDto
        expect(instance).to.be.a(Notes.NoteDto);
      });
