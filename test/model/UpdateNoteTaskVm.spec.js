...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateNoteTaskVm', function() {
      beforeEach(function() {
        instance = new Notes.UpdateNoteTaskVm();
      });

      it('should create an instance of UpdateNoteTaskVm', function() {
        // TODO: update the code to test UpdateNoteTaskVm
        expect(instance).to.be.a(Notes.UpdateNoteTaskVm);
      });
